...
import { createNamespace, getGlobalConfig } from '@grow-admin-rock/utils'
...
import { DarkModeToggle } from '@grow-admin-rock/layouts-component'
  ...
  <div :class="bem()">
    <div :class="bem('slogan')" class="hidden xl:flex">
      <div class="-enter-x flex p-[20px]">
        <!-- <img :title="title" class="h-[90px]" :alt="t('sys.app.name')" src="@/assets/images/logo-white.png"/> -->
      </div>
      <div class="my-auto">
        <img
          :alt="title"
