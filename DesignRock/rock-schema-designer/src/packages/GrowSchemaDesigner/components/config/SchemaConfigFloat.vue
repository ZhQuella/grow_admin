<template>
  <aside
    v-if="visible"
    class="absolute bottom-2.5 right-2.5 top-2.5 z-30 box-border flex w-[400px] min-h-0 flex-col overflow-hidden rounded-md border border-solid border-border bg-component shadow-card"
    @click.stop
  >
    <div
