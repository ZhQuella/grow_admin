export default {
  ...
  app: {
    ...
    copyright: '2023 grow-admin Technology'
  },
  exception: {
  ...
  login: {
    ...
    grow-adminOAuthTitle: 'grow-admin Authorization',
    signInFormTitle: 'Sign in',
    signUpFormTitle: 'Sign up',
    forgetFormTitle: 'Reset password',

    signInTitle: 'grow-admin Backstage management system',
    signInDesc: 'Management system template, build with monorepo!',
    policy: 'I agree to the xxx Privacy Policy',
    scanSign: `scanning the code to complete the login`,
    grow-adminOAuthRedicting: `Authorization server redicting...`,
    grow-adminOAuthCodeHandling: `Authorizing...`,
