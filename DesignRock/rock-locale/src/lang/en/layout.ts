export default {
  ...
  header: {
    ...
    originalEditPassWord: 'Old password',
    newEditPassWord: 'New password',
    againEditPassWord: 'Confirm password',
    editPassWordBtn: 'reset',
  ...
  setting: {
    ...
    menuTypeSidebarAndRecommend: 'Left menu and Top recomond mode',
